...
const staticRoutes = [
  ...
  { path: '/anime/popular', changefreq: 'daily', priority: '0.8' },
  { path: '/anime/genre/action', changefreq: 'weekly', priority: '0.7' },
  { path: '/anime/genre/fantasy', changefreq: 'weekly', priority: '0.7' },
