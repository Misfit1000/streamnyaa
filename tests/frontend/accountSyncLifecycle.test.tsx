...
const mock = vi.hoisted(() => ({ auth: {} as any, fetch: vi.fn(), write: vi.fn(), history: [] as any[] }));
...
beforeEach(() => {
  localStorage.clear(); mock.history = []; mock.fetch.mockReset(); mock.write.mockReset().mockResolvedValue({ ok: true });
