...
| Integrated anime cinema, episode selection, audio/quality controls, source ranking and recovery | Full-bleed title hero, synopsis/library/trailer actions, player and episode rail on one screen, direct episode jump, trust/remake filters, source sorting, automatic backup source selection, resume, PiP, and auto-next |
