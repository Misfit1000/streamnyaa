  ...
  return (
    <Screen title="Profile" subtitle="One account across web, desktop, and Android">
      ...
      <List.Section style={styles.list}>
        <List.Item title="Airing schedule" description="Episodes airing today and this week" left={(props) => <List.Icon {...props} icon="calendar-month-outline" color={theme.colors.primary} />} right={(props) => <List.Icon {...props} icon="chevron-right" />} onPress={() => navigation.navigate('Schedule')} />
