export const BLOG_POSTS = [
  ...
  },
  {
    ...
    seoTitle: 'Popular Anime Right Now - Top Airing Shows | StreamNyaa',
    category: 'Popular',
    ...
    summary: 'A practical article for finding anime with large current audience interest.',
    intro: 'Popular anime lists are useful when you want familiar titles with strong audience activity. This article focuses on high-interest anime that are currently relevant.',
    angle: 'viewer interest',
    readerPromise: 'Use this article to find safe picks with broad appeal, then compare scores, genres, episodes, and title pages before choosing what to follow.',
    articleKind: 'non_ai',
    sortRank: 80,
  },
  {
    ...
    readerPromise: 'Use this article to build a shortlist before the season gets crowded, with quick context for each title and direct StreamNyaa discovery links.',
    articleKind: 'non_ai',
    sortRank: 70,
  },
  {
