  ...
  return (
    <div className="relative flex min-h-[calc(100vh-72px)] items-center justify-center overflow-hidden bg-background px-3 py-4 text-white md:px-6">
      ...
      <img
        ...
        alt=""
        className="absolute inset-0 -z-30 h-full w-full scale-110 object-cover opacity-45 blur-2xl"
        aria-hidden="true"
        referrerPolicy="no-referrer"
      />
      <div className="absolute inset-0 -z-20 bg-[linear-gradient(115deg,rgba(5,5,7,0.96),rgba(5,5,7,0.72)_45%,rgba(225,29,72,0.22)),linear-gradient(180deg,rgba(5,5,7,0.72),#050507)]" />
      <div className="absolute inset-0 -z-10 opacity-30 [background-image:linear-gradient(115deg,rgba(225,29,72,0.18)_1px,transparent_1px),linear-gradient(25deg,rgba(255,255,255,0.08)_1px,transparent_1px)] [background-size:48px_48px,64px_64px]" />

      <div className="mx-auto grid w-full max-w-5xl overflow-hidden rounded-[30px] border border-white/12 bg-[#08080a]/92 shadow-2xl shadow-black/45 backdrop-blur-xl md:min-h-[520px] md:grid-cols-[0.95fr_1.05fr] lg:min-h-[560px]">
        <section className="flex min-h-0 items-center bg-[#08080a]/95 px-5 py-6 sm:px-8 md:px-10">
          <div className="mx-auto w-full max-w-[360px]">
            <div className="mb-7 flex items-center justify-between gap-4">
              <Link to="/" className="inline-flex items-center gap-2 text-sm font-black text-white">
                <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-primary text-white shadow-lg shadow-primary/25">
        ...
        <section className="relative hidden items-center justify-center bg-[#0d0d10]/90 p-5 md:flex lg:p-7">
