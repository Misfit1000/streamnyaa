...
export default function Blog() {
  ...
  return (
    <div className="container mx-auto px-4 md:px-10 py-10 md:py-14">
      <Seo title="Anime Blog - Trending Anime, Schedules and Episode Updates | StreamNyaa" description="Read anime blog posts about trending anime, popular airing shows, upcoming anime, daily release schedules, and recent episode updates." canonicalPath="/blog" jsonLd={jsonLd} />
      <section className="max-w-5xl"><div className="flex items-center gap-3 text-primary text-sm font-bold uppercase mb-4"><span className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center"><Newspaper className="w-5 h-5" /></span>StreamNyaa Blog</div><h1 className="text-3xl md:text-5xl font-black tracking-tight mb-4">Anime blog for trending shows, release schedules, and episode updates</h1><p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-3xl">Browse focused anime articles covering trending shows, popular titles, upcoming releases, episode updates, and daily anime schedules without leaving StreamNyaa.</p></section>
